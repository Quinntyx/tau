    ...
    pub fn for_appearance(appearance: WindowAppearance) -> Self {
        match appearance {
            WindowAppearance::Light | WindowAppearance::VibrantLight => Self {
                canvas: rgb(0xf5f5f7),
                toolbar: rgb(0xfafafa),
                sidebar: rgb(0xeeeef2),
                surface: rgb(0xffffff),
                elevated: rgb(0xffffff),
                text: rgb(0x1d1d1f),
                secondary_text: rgb(0x6e6e73),
                tertiary_text: rgb(0x8e8e93),
                separator: rgb(0xd2d2d7),
                accent: rgb(0x007aff),
                accent_hover: rgb(0x006ee6),
                selection: rgb(0xd8eaff),
                error_surface: rgb(0xffe8e7),
                error_text: rgb(0xb42318),
                success_surface: rgb(0xe7f6eb),
                success_text: rgb(0x257a3e),
            },
